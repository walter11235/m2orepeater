...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/@directus/extension-toolkit/mixins/interface.js":[function(require,module,exports) {
module.exports = {
  props: {
...
Store.prototype.commit = function commit(_type, _payload, _options) {
  ...
  if (undefined !== 'production' && options && options.silent) {
...
function installModule(store, rootState, path, module, hot) {
  ...
  if (module.namespaced) {
    if (store._modulesNamespaceMap[namespace] && undefined !== 'production') {
...
var mapState = normalizeNamespace(function (namespace, states) {
  ...
  if (undefined !== 'production' && !isValidMap(states)) {
...
var mapMutations = normalizeNamespace(function (namespace, mutations) {
  ...
  if (undefined !== 'production' && !isValidMap(mutations)) {
...
var mapGetters = normalizeNamespace(function (namespace, getters) {
  ...
  if (undefined !== 'production' && !isValidMap(getters)) {
...
var mapActions = normalizeNamespace(function (namespace, actions) {
  ...
  if (undefined !== 'production' && !isValidMap(actions)) {
...
},{}],"../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
...
var _interface = _interopRequireDefault(require("@directus/extension-toolkit/mixins/interface"));
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    if (this.value) {
      if (this.value.collection) {
        ...
        console.log(this.selectedCollection); //this.itemOptions = this.getItems(this.selectedCollection);

        console.log("select options in mounted"); //console.log(this.itemOptions);
  ...
  // necessary methods
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapState)(['currentProjectKey'])), {}, {
    ...
    testMethod: function testMethod() {
      console.log("inside consoleMethod"); //console.log(this.$api.getItems);
    },
     ...
     */
    emitCollectionValue: function emitCollectionValue($event) {
     ...
     */
    emitItemValue: function emitItemValue(event) {
      console.log("inside emit Value");
      console.log(event);
      this.selectedvalue = event; //console.log("selected value:");
      //console.log(this.selectedvalue);

      this.toEmitObject.item = event; //if (this.toEmitObject.collection) {
     ...
     */
    getItems: function () {
      var _getItems = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(collectionArray) {
        var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                choices = {};
                Object.keys(collectionArray).forEach(function (key) {
                  choices[key] = _this.$helpers.formatTitle(key);
                });
    ...
    getItemsFromSelectedCollection: function getItemsFromSelectedCollection(selectedCollection) {
      var _this2 = this;

      this.$api.getItems(selectedCollection, {}).then(function (res) {
  ...
  computed: {
    choices: function choices() {
      ...
      var collections = this.$store.state.collections || {};
      var choices = {};
      Object.keys(collections).filter(function (key) {
        ...
        choices[key] = _this3.$helpers.formatTitle(key);
      });
      return choices;
    }
    /*itemschoices() {
  ...
  watch: {
     ...
     */
    selectedCollection: function selectedCollection(currentSelectedCollection, oldSelectedCollection) {
      var _this4 = this;

      if (!oldSelectedCollection && currentSelectedCollection) {
        this.$api.getItems(currentSelectedCollection, {}).then(function (res) {
          console.log(res.data);
          var arr = res.data;
          var result = [];
          var objectresult = {};
...
exports.default = _default;
        var $70248b = exports.default || module.exports;
      
      if (typeof $70248b === 'function') {
        $70248b = $70248b.options;
      }
    
        /* template */
        Object.assign($70248b, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { staticClass: "content two-up", attrs: { id: "app" } },
    [
      _c("v-select", {
        attrs: {
          options: _vm.choices,
      ...
      _vm._v(" "),
      _c("v-select", {
        attrs: { options: _vm.items, autocomplete: "", "return-object": "" },
        on: { input: this.emitItemValue },
        model: {
      ...
      _vm._v(" "),
      _c("div", [_vm._v(_vm._s(_vm.selectedCollection))]),
      _vm._v(" "),
      _c("div", [_vm._v(_vm._s(_vm.selectedvalue))]),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$70248b', $70248b);
          } else {
            api.reload('$70248b', $70248b);
          }
        }
...
},{"@directus/extension-toolkit/mixins/interface":"../node_modules/@directus/extension-toolkit/mixins/interface.js","vuex":"../node_modules/vuex/dist/vuex.esm.js","_css_loader":"../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/@directus/extension-toolkit/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","input.vue"], "__DirectusExtension__")
